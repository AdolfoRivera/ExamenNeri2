...
public class Base {
	...
	public WebElement finElementtest(By locator) {
		return driver.findElement(locator); // POR SI HAY ALGUN CAMBIO DE VERCION SE MODIFICA EL NOMBRE DEL METODO SE
											// VIENE AQUI Y LISTO
	}

	// METODO PARA DEBUELVE LISTA DE ELEMENTODS
	public List<WebElement> finElements(By locator) {
		return driver.findElements(locator); // POR SI HAY ALGUN CAMBIO DE VERCION SE MODIFICA EL NOMBRE DEL METODO SE
												// VIENE AQUI Y LISTO
	}
